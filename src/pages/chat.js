    ...
    <div className="h-screen w-full py-6 px-4 bg-white to-black grid place-items-center">
      ...
      <div className="flex justify-center">
        <div className="flex items-center gap-4">
          ...
          <div className={`${selected === 'SELECT' || selected === '' ? 'bg-gray-600 cursor-not-allowed' : 'bg-primary cursor-pointer'} w-full md:w-32 mx-auto py-4 px-6 text-white font-bold rounded-md flex justify-center`} onClick={() => send()}>
            send
          </div>
        </div>
      </div>
