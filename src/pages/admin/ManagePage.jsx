...
export default function ManagePage() {
  ...
  useEffect(() => {
    const formatUserPhoneNumber = (phone) => {
      ...
      const html = `
        <div className="flex items-center gap-2 cursor-pointer justify-evenly">
                ...
                >
                  ...
                  <td>
                    <div
                      ...
                      id={`last_7_days_growth_${user?.username} `}
                    >
                      N/A
                    </div>
                  </td>
                  ...
                  <td>
                    <div className="relative group">
                      {user?.tag?.tag1 && (
                        <div className="absolute top-0 left-0 hidden w-full h-full bg-black/20 group-hover:grid place-items-center">
                          <div
                            className="w-[30px] h-[30px] grid place-items-center rounded-lg bg-black text-white cursor-pointer"
                            onClick={() => {
                              setShowAddTagModal(true);
                              setUserToAddTagFor(user);
                            }}
                          >
                            <FaPen />
                          </div>
                      ...
                      {user?.tag?.tag1 ? (
                        <div className="flex items-center gap-2">
                          <div
                            style={{ backgroundColor: user?.tag?.color }}
                            className={`text-white w-[55px] h-[30px] rounded-lg flex items-center justify-center gap-1 text-xs font-semibold`}
                          >
                        ...
                        <div
                          className="grid bg-black rounded-full cursor-pointer h-7 w-7 to-white place-items-center"
                          onClick={() => {
                            setShowAddTagModal(true);
                            setUserToAddTagFor(user);
                          }}
  ...
  return (
    <>
      <div className="fixed top-0 left-0 z-20 w-full h-screen font-MontserratRegular bg-black/20">
        <div
          className="fixed top-0 left-0 w-full h-screen bg-black/20 z-[2] cursor-pointer"
          onClick={() => {
            setShowAddTagModal(false);
          }}
        ></div>
        ...
        <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[3] min-w-[300px] bg-white rounded-[10px] pb-2 px-4">
          {processing && (
            <div className="fixed top-0 left-0 flex items-center justify-center w-full h-full text-white bg-black/20">
              <img
                src={LOGO}
                alt="Loading"
                ...
                return (
                  ...
                  >
                    <label
                      ...
                      className={`w-8 h-3 cursor-pointer rounded-lg`}
                      onClick={() => {
                        setColor(colorC);
                      }}
                    ></label>
            ...
            <div className="flex justify-between gap-3 mt-3">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  name="inputA"
                  id="inputA"
                  className="h-[34px] w-[125px] px-2 rounded-lg border border-gray-500 outline-none shadow-2xl"
                  minLength={1}
                  maxLength={7}
          ...
          <button
            className="w-full h-[25px] rounded-lg bg-blue-600 text-white mt-3"
            onClick={handleSave}
          >
            Save
          </button>
...
export const ChangeStatusModal = ({ user, refreshUsers, setRefreshUsers }) => {
  ...
  return (
    <div className="">
      <div
        className="w-[120px] h-[35px] flex items-center gap-2 justify-center rounded-[10px] bg-black text-white cursor-pointer capitalize"
        onClick={() => {
      ...
      {showModal && (
        <div className="w-full h-full">
          {processing && (
            <div className="fixed top-0 left-0 z-20 flex items-center justify-center w-full h-full text-white bg-black/20">
              <img
                src={LOGO}
                alt="Loading"
                className="w-10 h-10 animate-spin"
