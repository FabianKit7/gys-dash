      ...
      <div className="relative h-screen xl:h-full overflow-auto">
        ...
        <div className="flex flex-col xl:flex-row justify-between gap-2 p-7 md:p-10">
          <div className="flex flex-col justify-center md:justify-start items-center md:mt-[39px]">
            ...
            <h2 className='font-bold text-black text-[20px] my-1 font-MontserratBold'>@{user?.username}</h2>
          ...
          <div className="w-full">
            <div className="flex flex-col gap-5">
              ...
              <div className={`${mode === "auto" ? "border-[4px] border-black h-[230px] md:h-[110px] lg:h-[200px]" : "h-[52px]"} overflow-hidden py-[14px] md:py-5 px-[14px] md:px-10 cursor-pointer shadow-[0_0_3px_#00000040] rounded-[10px] flex items-center gap-2 md:gap-5`} style={{
              ...
              <div className={`${mode === "follow" ? "border-[4px] border-black h-[270px] sm:h-[200px] md:h-[110px] lg:h-[200px]" : "h-[52px]"} overflow-hidden py-[14px] md:py-5 px-[14px] md:px-10 cursor-pointer shadow-[0_0_3px_#00000040] rounded-[10px] flex items-center gap-2 md:gap-5`} style={{
                transition: 'all .3s ease-in,border .1s ease-in'
              ...
              <div className={`${mode === "unfollow" ? "border-[4px] border-black h-[230px] md:h-[110px] lg:h-[200px]" : "h-[52px]"} overflow-hidden py-[14px] md:py-5 px-[14px] md:px-10 cursor-pointer shadow-[0_0_3px_#00000040] rounded-[10px] flex items-center gap-2 md:gap-5`} style={{
                transition: 'all .3s ease-in,border .1s ease-in'
              ...
              <div className={`${mode === "off" ? "border-[4px] border-black h-[230px] md:h-[110px] lg:h-[200px]" : "h-[52px]"} overflow-hidden py-[14px] md:py-5 px-[14px] md:px-10 cursor-pointer shadow-[0_0_3px_#00000040] rounded-[10px] flex items-center gap-2 md:gap-5`} style={{
                transition: 'all .3s ease-in,border .1s ease-in'
            ...
            <div className="flex justify-center my-4">
              <button className='rounded-[10px] mx-auto font-MontserratSemiBold font-bold text-base py-4 w-full xl:w-[300px] h-[72px] bg-black text-white' onClick={(e) => {
                e.preventDefault()
                !loading && handleSave();
