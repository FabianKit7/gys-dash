                ...
                <div className="">
                    ...
                    >
                        ...
                        <div className="flex justify-center gap-3 my-4">
                            <button
                                type="submit"
                                className="text-white bg-primary font-MontserratSemiBold text-[16px] rounded-[5px] px-6 h-[40px] w-fit font-semibold"
                    ...
                    {drc && <div className="mb-3">
                        ...
                        <div className="flex justify-center w-full gap-2">
                            <button
                                type="button"
                                className="text-white bg-primary font-MontserratSemiBold text-[16px] rounded-[5px] py-2 px-6 h-[52px] w-fit font-semibold"
                                style={{ boxShadow: '0 10px 30px -12px rgb(255 132 102 / 47%)' }}
                    ...
                    <div className="text-center">
                        <p className="flex items-center justify-center gap-2 text-sm text-black font-MontserratRegular">
                            ...
                            <a
                                ...
                                rel="noreferrer"
                            >
                                <span className="text-black font-MontserratSemiBold font-[600] text-[14px] mt-3">
                                    Reset it here
                                </span>
                            </a>
                        </p>
